...
javax.servlet.http.HttpSession existingSession2 = request.getSession(false);

// Check if session exists and if the role is "admin"
if (existingSession2 == null || existingSession2.getAttribute("role") == null
		|| !existingSession2.getAttribute("role").equals("admin")) {
			...
			<div
				...
				<div class="flex items-center">
					<span class="mr-2 text-sm font-medium text-white">All
						Products</span>
					<form
						action="<%=request.getContextPath()%>/AdminPageSearchProductServlet"
						method="GET">
						<div class="flex items-center">
				...
				<tr class="bg-white border-b hover:bg-gray-50">
					...
					<td class="px-6 py-4"><a
						...
						class="font-medium text-blue-600 hover:underline">Edit</a> | <a
                            href="<%=request.getContextPath()%>/DeleteProductServlet?productId=<%=product.getProductId()%>"
