...
<form action="../AddCategoryServlet" method="post">
    <div class="form-group">
        ...
        <input class="border border-red-300" type="text" id="categoryName" name="categoryName" required>
    </div>
    
    
      <button type="submit" value="AddCategory" class="text-white bg-indigo-500 hover:bg-indigo-800  font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Add Category </button>
    <%
