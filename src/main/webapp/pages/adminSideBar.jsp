...
<div class="sidebar w-64 h-[100vh] relative bg-gray-800"> 
  ...
  <div class="p-3">
    <ul>
                    ...
                    <li class="my-2">
                        <a href="<%=request.getContextPath()%>/pages/testManageProduct.jsp" class="flex items-center p-3 rounded-lg text-white hover:bg-indigo-600 <%= request.getRequestURI().endsWith("testManageProduct.jsp") ? "active-link" : "" %>">
                            <i class='bx bx-customize mr-3'></i>
                            Product
                        </a>
                    </li>
