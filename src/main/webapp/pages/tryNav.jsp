...
<header>
        <div class="containerNav mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                <div class="hidden w-full text-gray-600 md:flex md:items-center">
                    ...
                    <span class="mx-1 text-sm">Nepal</span>
                </div>
            ...
            <span class="absolute inset-y-0 left-0 pl-3 flex items-center">
                ...
                <form action="<%=request.getContextPath()%>/SearchProductServlet" method="GET" class="max-w-lg mx-auto">
    <div class="flex">
        ...
        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                <% for (ProductCategoryModel pm : categories) { %>
                    <li>
                        <a href="<%=request.getContextPath()%>/pages/index.jsp?categoryId=<%=pm.getProductCategoryId()%>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            <%= pm.getCategoryName() %>
                        </a>
                    </li>
                <% } %>
        ...
        <div class="relative w-full">
            <input type="search" id="search-dropdown" name="query" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500  " placeholder="Search for Gadgets..." required />
            <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white  rounded-e-lg border border-gray-500 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-blue-300">
